OBJS=msl.o ge.o pulse.o msl-timings.o console.o console_socket.o peripherical.o log.o reader.o cap.o transcode.o cardreader.o printer.o connector34.o channel.o gecode.o binimage.o disasm.o sat_batches.o alu_cc.o alu_bin.o alu_logic.o alu_dec.o alu_reg.o
CFLAGS+=-MD -MP
CC=gcc
